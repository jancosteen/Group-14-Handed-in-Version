...
namespace Entities.Models
{
    public partial class OrderMateDbFinalContext : IdentityDbContext
    {
        ...
        public virtual DbSet<SalesByMenuItemReport> SalesByMenuItemReport { get; set; }
        public virtual DbSet<SalesByRestaurantReport> SalesByRestaurantReport { get; set; }
        public virtual DbSet<PeakHourReport> PeakHourReport { get; set; }
        public virtual DbSet<SupplierOrderReport> SupplierOrderReport { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesByMenuItemReport>()
                .HasNoKey();

            modelBuilder.Entity<SalesByRestaurantReport>()
                .HasNoKey();

            modelBuilder.Entity<PeakHourReport>()
                .HasNoKey();

            modelBuilder.Entity<SupplierOrderReport>()
                .HasNoKey();
            ...
            modelBuilder.Entity<AdvertisementDate>(entity =>
            {
                ...
                entity.HasOne(d => d.AdvertisementIdFkNavigation)
                    .WithMany(p => p.AdvertisementDate)
            ...
            modelBuilder.Entity<AdvertisementPrice>(entity =>
            {
                ...
                entity.HasOne(d => d.AdvertisementIdFkNavigation)
                    .WithMany(p => p.AdvertisementPrice)
                    .HasForeignKey(d => d.AdvertisementIdFk)
            ...
            {
                entity.HasKey(e => new { e.ShiftIdFk, e.EmployeeIdFk })
            ...
            {
                entity.HasKey(e => new { e.MenuItemIdFk, e.MenuItemTypeIdFk })
            ...
            {
                entity.HasKey(e => new { e.MenuItemIdFk, e.AllergyIdFk })
            ...
            {
                entity.HasKey(e => new { e.SpecialIdFk, e.MenuItemIdFk })
            ...
            {
                entity.HasKey(e => new { e.ProductIdFk, e.StockTakeIdFk })
            ...
            {
                entity.HasKey(e => new { e.QrCodeIdFk, e.SeatingIdFk })
                ...
                entity.HasOne(d => d.QrCodeIdFkNavigation)
                    .WithOne(p => p.QrCodeSeating)
                    .HasForeignKey<QrCodeSeating>(d => d.QrCodeIdFk)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => new { e.RestaurantFacilityIdFk, e.RestaurantIdFk })
            ...
            modelBuilder.Entity<Restaurant>(entity =>
            {
                ...
                entity.Property(e => e.RestaurantAddressLine3)
                ...
                entity.Property(e => e.RestaurantCoordinates)
                    .IsRequired()
            ...
            {
                entity.HasKey(e => new { e.RestaurantIdFk, e.AdvertisementIdFk })
            ...
            modelBuilder.Entity<RestaurantFacility>(entity =>
            {
                ...
                entity.Property(e => e.RestaurantFacilityId)
            ...
            {
                entity.HasKey(e => new { e.RestaurantTypeIdFk, e.RestaurantIdFk })
            ...
            {
                entity.HasKey(e => new { e.ProductIdFk, e.SupplierOrderIdFk })
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.Password)
                    ...
                    .IsUnicode(false);
                */
                entity.Property(e => e.User_Contact_Number)
                    .IsRequired()
            ...
            //    entity.Property(e => e.UserRoleIdFk).HasColumnName("User_Role_Id_FK");
                ...
                entity.Property(e => e.User_Surname)
                    .IsRequired()
